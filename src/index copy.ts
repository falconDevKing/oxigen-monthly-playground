...
//   //   return accumulator;
//   // }, 0);
//   // console.log(tWeekClassesVisits.length, attendance, missedVisits,  unpaidVisits);

//   // let totalWeeklyBilledIncome = 0;
//   // let totalWeeklyIncome = 0;
//   // let totalTaxIncome = 0;
//   // let totalTransactionIncome = 0;
//   // (tTransactions as any[])?.forEach((transaction: any) => {
//   //   const considerableTransaction = moment(transaction?.TransactionTime).isBetween(previousWeekBegin, weekBegin, "day", "[)");
//   //   // if (considerableTransaction) {
//   //   // transaction.PurchasedItems.forEach((purchasedItem: any) => {
//   //   if (transaction.Settled) {
//   //     totalTransactionIncome = totalTransactionIncome + transaction.Amount;
//   //     // if (purchasedItem.ContractId) {
//   //     //   totalWeeklyBilledIncome = totalWeeklyBilledIncome + purchasedItem.TotalAmount;
//   //     // }
//   //   }
//   //   // });
//   //   // } else {
//   //   //   console.log({ id: transaction.Id, dt: transaction.transactionDateTime });
//   //   // }
//   // });
//   // (tSales as any[])?.forEach((sale: any) => {
//   //   const considerableSale = moment(sale?.SaleDateTime).isBetween(previousWeekBegin, weekBegin, "day", "[)");
//   //   if (considerableSale) {
//   //     const purchasedItems = sale.PurchasedItems.forEach((purchasedItem: any) => {
//   //       // if (sale.Payments[0].TransactionId) {
//   //       totalWeeklyIncome = totalWeeklyIncome + purchasedItem.TotalAmount;
//   //       totalTaxIncome = totalTaxIncome + purchasedItem.TaxAmount;
//   //       if (purchasedItem.ContractId) {
//   //         totalWeeklyBilledIncome = totalWeeklyBilledIncome + purchasedItem.TotalAmount;
//   //       }
//   //     });
//   //   }
//   // });
//   // console.log(totalWeeklyBilledIncome, totalWeeklyIncome, totalTransactionIncome, totalTaxIncome);

//   // const nonFlat = tClients.reduce((accum, curVal) => {
//   //   if (curVal.AccountBalance !== 0) {
//   //     const mod = { id: curVal.Id, acb: curVal.AccountBalance, status: curVal.Status };
//   //     return [...accum, mod];
//   //   }
//   //   return accum;
//   // }, [] as { id: string; acb: number; status: string }[]);
